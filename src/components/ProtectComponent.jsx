            ...
            <div className="max-w-7xl mx-auto px-4 ">
                <div className=" flex md:flex-row flex-col gap-20 items-center">
                    <div className="md:w-[55%] w-full flex flex-col gap-4">
                        ...
                        <p className="lg:text-3xl md:text-2xl text-xl text-white">Fort Knox Solutions provides premium security film and door reinforcements to keep your home safe</p>
